-- studio_promotions 우선순위 컬럼 추가 스크립트
-- Supabase SQL Editor 에서 전체 선택 후 실행하세요.

-- 1) studio_promotions 테이블에 priority 컬럼 추가
...
CREATE INDEX IF NOT EXISTS idx_studio_promotions_priority_class_date
ON public.studio_promotions (priority ASC, class_date DESC);
